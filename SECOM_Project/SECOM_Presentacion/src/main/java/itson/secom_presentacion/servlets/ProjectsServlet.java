...
@WebServlet(name = "ProjectsServlet", urlPatterns = {"/api/projects", "/api/projects/*"})
public class ProjectsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            ...
            body.put("ok", true);
            body.put("data", BackendStore.listProjects());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            ...
            Map<String, Object> saved = BackendStore.saveProject(payload);
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (id == null) {
            JsonResponse.send(response, HttpServletResponse.SC_BAD_REQUEST,
                    Map.of("ok", false, "message", "Falta el ID del proyecto."));
            return;
        }

        try {
            Map<String, Object> patch = RequestJson.readMap(request);
            Map<String, Object> saved = BackendStore.updateProject(id, patch);
