...
@WebServlet(name = "PaquetesServlet", urlPatterns = {"/api/paquetes", "/api/paquetes/*"})
public class PaquetesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            ...
            body.put("ok", true);
            body.put("data", BackendStore.listPaquetes());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            ...
            Map<String, Object> saved = BackendStore.savePaquete(payload);
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (id == null) {
            JsonResponse.send(response, HttpServletResponse.SC_BAD_REQUEST,
                    Map.of("ok", false, "message", "Falta el ID del paquete."));
            return;
        }

        try {
            Map<String, Object> patch = RequestJson.readMap(request);
            Map<String, Object> saved = BackendStore.updatePaquete(id, patch);
