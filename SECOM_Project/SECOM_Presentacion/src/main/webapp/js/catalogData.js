...
export const DEFAULT_INSUMO_CATALOG = [
  { codigo:'PANEL-550', descripcion:'Panel solar monocristalino 550 W (paneles)', categoria:'Paneles', unidad:'PZA', precio: 2650, impuestoPct: 0.16 },
  { codigo:'PANEL-610', descripcion:'Panel solar monocristalino 610 W (paneles premium)', categoria:'Paneles', unidad:'PZA', precio: 3150, impuestoPct: 0.16 },
  { codigo:'INV-STR', descripcion:'Inversor interconectado string (inversor)', categoria:'Inversores', unidad:'PZA', precio: 15800, impuestoPct: 0.16 },
  { codigo:'INV-HIB', descripcion:'Inversor híbrido con monitoreo (inversor)', categoria:'Inversores', unidad:'PZA', precio: 29900, impuestoPct: 0.16 },
  { codigo:'EST-AL', descripcion:'Estructura de aluminio para azotea o techo (estructura)', categoria:'Estructura', unidad:'SERV', precio: 7600, impuestoPct: 0.16 },
  { codigo:'EST-LA', descripcion:'Estructura reforzada para lámina o teja (estructura)', categoria:'Estructura', unidad:'SERV', precio: 10800, impuestoPct: 0.16 },
  { codigo:'CAB-FV', descripcion:'Cable fotovoltaico y conectores MC4 (cableado)', categoria:'Cableado', unidad:'SERV', precio: 3200, impuestoPct: 0.16 },
  { codigo:'PROT-CC', descripcion:'Protecciones CC/CA y tablero de interconexión (protecciones)', categoria:'Protecciones', unidad:'SERV', precio: 5900, impuestoPct: 0.16 },
  { codigo:'MON-APP', descripcion:'Monitoreo remoto y puesta en marcha (monitoreo)', categoria:'Monitoreo', unidad:'SERV', precio: 2500, impuestoPct: 0.16 },
  { codigo:'TIERRA', descripcion:'Puesta a tierra y canalización (seguridad)', categoria:'Seguridad', unidad:'SERV', precio: 3900, impuestoPct: 0.16 },
  { codigo:'TRAM-CFE', descripcion:'Trámite de interconexión ante CFE (trámite)', categoria:'Trámite', unidad:'SERV', precio: 3600, impuestoPct: 0.16 },
  { codigo:'MO-INST', descripcion:'Mano de obra de instalación (instalación)', categoria:'Instalación', unidad:'SERV', precio: 9800, impuestoPct: 0.16 },
  { codigo:'FLETE', descripcion:'Flete, maniobras y logística (logística)', categoria:'Logística', unidad:'SERV', precio: 2600, impuestoPct: 0.16 },
  { codigo:'BAT-LFP', descripcion:'Banco de baterías LiFePO4 de respaldo (baterías)', categoria:'Baterías', unidad:'PZA', precio: 38900, impuestoPct: 0.16 },
  { codigo:'ING', descripcion:'Ingeniería, planos y memoria técnica (ingeniería)', categoria:'Ingeniería', unidad:'SERV', precio: 3800, impuestoPct: 0.16 },
];
...
export const DEFAULT_PACKAGE_PRESETS = [
  {
    ...
    items: [
      ...
      { codigo: 'INV-STR', cantidad: 1, precioOverride: 14200, precioOverrideAlt: 16800, threshold: 8 },
      { codigo: 'EST-AL', cantidad: 1 },
      { codigo: 'CAB-FV', cantidad: 1 },
      { codigo: 'PROT-CC', cantidad: 1, precioOverride: 5400 },
      { codigo: 'MO-INST', cantidad: 1, precioOverride: 8600 },
      { codigo: 'TRAM-CFE', cantidad: 1, precioOverride: 3200 },
    ],
  },
  {
    key: 'intermedio',
    ...
    items: [
      { codigo: 'PANEL-550', cantidadMode: 'paneles' },
      { codigo: 'INV-STR', cantidad: 1, precioOverride: 15800, precioOverrideAlt: 18500, threshold: 10 },
      { codigo: 'EST-LA', cantidad: 1, precioOverride: 10400 },
      { codigo: 'CAB-FV', cantidad: 1, precioOverride: 3600 },
      { codigo: 'PROT-CC', cantidad: 1, precioOverride: 6500 },
      { codigo: 'MON-APP', cantidad: 1 },
      { codigo: 'TIERRA', cantidad: 1 },
      { codigo: 'MO-INST', cantidad: 1, precioOverride: 10200 },
  ...
  },
  {
    ...
    items: [
      ...
      { codigo: 'EST-LA', cantidad: 1, precioOverride: 11500 },
      { codigo: 'CAB-FV', cantidad: 1, precioOverride: 4200 },
      { codigo: 'PROT-CC', cantidad: 1, precioOverride: 7600 },
      { codigo: 'MON-APP', cantidad: 1, precioOverride: 3200 },
      { codigo: 'TIERRA', cantidad: 1, precioOverride: 4600 },
      { codigo: 'ING', cantidad: 1 },
      { codigo: 'MO-INST', cantidad: 1, precioOverride: 11800 },
      { codigo: 'TRAM-CFE', cantidad: 1 },
      { codigo: 'FLETE', cantidad: 1, precioOverride: 3100 },
    ],
  },
];
